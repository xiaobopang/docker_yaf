...
RUN apt update \
    ...
    && apt install -y nginx-full curl zip \
    && zlib1g-dev vim libssl-dev unzip \
    && wget git make sudo openssh-server subversion supervisor \
    && php7.1 php7.1-fpm php7.1-cli php7.1-gd \
